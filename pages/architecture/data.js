...
export default {
	logo: STATIC + "/images/architecture_logo.png",
	...
	articles: [
		{
			...
			date: "29.04.2018",
			category: "Argentina",
			image: STATIC + "/images/equestrian_house.jpg",
			content: [
			...
			more:
				"https://www.dezeen.com/2018/04/29/equestrian-house-luciano-kruk-board-marked-concrete-holiday-home-argentina-blackened-wood/",
			extras: {
		...
		},
		{
			...
			date: "09.10.2014",
			category: "China",
			image: STATIC + "/images/garden_chapel.jpg",
			content: [
			...
			more:
				"https://www.dezeen.com/2014/10/09/nanjing-wanjing-garden-chapel-azl-architects/",
			extras: {
				title:
					"This chapel features semi-transparent walls and a butterfly roof",
				content:
					"The building's most noticeable feature is its profile – a variation on the typical butterfly roof, an inverted structure that rises at its edges rather that at its centre."
			}
		},
		{
			...
			date: "29.04.2018",
			category: "Slovenia",
			image: STATIC + "/images/open_air_chapel.jpg",
			content: [
			...
			more:
				"https://www.dezeen.com/2018/04/29/sloping-concrete-volumes-enclose-social-hub-chapel-in-slovenian-village-architecture/",
			extras: {
				title: "Sloping concrete volumes in Slovenian village",
				content:
					"The concrete structure is positioned centrally on the vacant plot and is partially embedded in a grassy bank. A narrow path extends across the grass to connect the main functional area with the adjacent road."
			}
		}
	]
};
