...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentWillUpdate() {
			var daysInYear = [];
			daysInYear.push(this.setDays(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "M")) - 1, this.state.inViewYear));
			if (daysInYear[0] != this.state.daysInYear[0]) console.log(daysInYear[0], this.state.daysInYear[0]);
		}
	}, {
		key: "setDay",
		value: function setDay(date) {
			...
			this.setYear(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(date, "YYYY")));
...
//# sourceMappingURL=3.ae90c69ee7f0e86d42f5.hot-update.js.map