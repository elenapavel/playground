...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentWillUpdate() {
			...
			this.setDaysInMonthView(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "M")) - 1, parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "YYYY")));
		}
	}, {
		...
		value: function componentDidUpdate() {
			...
			daysInYear2.push(this.setDays(currentMonth, currentYear));

			if (!Object.is(daysInYear2[0][0], this.state.daysInYear[0][0])) {
				// this.setState({ daysInYear: daysInYear2 });
			}
		}
	}, {
		key: "setDay",
...
//# sourceMappingURL=3.8322eda4d92044d37c28.hot-update.js.map