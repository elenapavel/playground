...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentDidUpdate() {
			...
			if (!Object.is(daysInYear[0][0], this.state.daysInYear[0][0])) this.setDaysInMonthView(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "M")) - 1, parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "YYYY")));
		}
	}, {
		key: "setDay",
...
//# sourceMappingURL=3.ea1af103ecdc218be4ab.hot-update.js.map