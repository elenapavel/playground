...
var DaysList = function (_Component) {
	...
	_createClass(DaysList, [{
		...
		value: function render() {
			...
			if (view == "month") return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({}, props, { daysInMonth: daysInMonth[0], __source: {
				...
				daysInMonth.map(function (month, key) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({}, props, { daysInMonth: month, __source: {
							fileName: _jsxFileName,
							lineNumber: 21
						}
					}));
...
//# sourceMappingURL=3.e2364e2c5d07bac3208d.hot-update.js.map