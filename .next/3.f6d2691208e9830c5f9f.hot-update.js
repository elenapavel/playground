...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentDidUpdate() {
			...
			this.setYear(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "YYYY")));
			this.setDaysInMonthView(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(this.state.selectedDate, "M")) - 1);
		}
	}, {
		key: "setDay",
...
//# sourceMappingURL=3.f6d2691208e9830c5f9f.hot-update.js.map