...
var DaysList = function (_Component) {
	...
	_createClass(DaysList, [{
		...
		value: function render() {
			...
			if (days != null && days.length != 0) if (view == "month") return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({}, props, { days: days[0], __source: {
				...
				days.map(function (month, key) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({ key: key }, props, { days: days[key], __source: {
							fileName: _jsxFileName,
							lineNumber: 22
						}
					}));
...
//# sourceMappingURL=3.20f54ea11813b6163823.hot-update.js.map