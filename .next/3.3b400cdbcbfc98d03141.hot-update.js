...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentWillUpdate() {
			if (this.state.inViewMonth != parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(selectedDate, "M")) - 1) this.setMonth(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(selectedDate, "M")) - 1);
			if (this.state.inViewYear != parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(selectedDate, "YYYY"))) this.setYear(parseInt(__WEBPACK_IMPORTED_MODULE_1_date_fns_format___default()(selectedDate, "YYYY")));
		}
	}, {
...
//# sourceMappingURL=3.3b400cdbcbfc98d03141.hot-update.js.map