...
var DaysList = function (_Component) {
	...
	_createClass(DaysList, [{
		...
		value: function render() {
			...
			if (daysInMonth.length != 0) if (view == "month") return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({}, this.props, { daysInMonth: daysInMonth[0], __source: {
				...
				daysInMonth.map(function (month, key) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Month__["a" /* default */], _extends({
						key: key
					}, _this2.props, {
...
//# sourceMappingURL=3.3b2e94e4c7597d2b950d.hot-update.js.map