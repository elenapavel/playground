...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function setMonths() {
			...
			var daysInYear = [];
			new Array(12).fill().forEach(function (month, key) {
				daysInYear.push(_this2.setDaysInMonth(key, inViewYear));
			});
			return daysInYear;
		}
	}, {
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__DaysList__["a" /* default */], {
							view: view,
							daysInMonth: this.setDaysInYear(),
...
//# sourceMappingURL=3.490669cdb2fd01fb71f8.hot-update.js.map