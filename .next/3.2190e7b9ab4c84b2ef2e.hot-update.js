...
var Calendar = function (_Component) {
	...
	_createClass(Calendar, [{
		...
		value: function componentDidUpdate() {
			...
			if (!Object.is(daysInYear2[0], this.state.daysInYear[0])) {
				console.log(daysInYear2[0], this.state.daysInYear[0]);
			}
		}
	}, {
		key: "setDay",
...
//# sourceMappingURL=3.2190e7b9ab4c84b2ef2e.hot-update.js.map